...
train_pipeline = [
    ...
    dict(type='MCAnalysis', look_num=9, stride=50, aperture_size=500, random_factor=0.1, rm_taylor=24, ad_taylor=30),
...
test_pipeline = [
    dict(type='LoadSLCMatFromFile'),
    dict(type='MCAnalysis', look_num=9, stride=50, aperture_size=500, random_factor=0.0, rm_taylor=24, ad_taylor=30),
