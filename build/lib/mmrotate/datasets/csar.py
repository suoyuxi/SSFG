...
class CSARDataset(CustomDataset):
    ...
    """
    CLASSES = ('A220', 'A320', 'A330', 'Boeing737', 'Boeing747', 'Boeing767', 'Boeing777', 'Helicopter',
                'GulfStream', 'Fokker-50', 'other_freighter', 'other_civil_aircraft',
                'General_Cargo_Ship', 'Bulk_Carrier', 'Container_Ship', 'Oil_Tanker', 'Warship', 'Moving_Ship', 'other_ship',
                'Tank', 'Tower', 'Bridge')
    ...
    def __init__(self,
        ...
        super(CSARDataset, self).__init__(ann_file, pipeline, **kwargs)
