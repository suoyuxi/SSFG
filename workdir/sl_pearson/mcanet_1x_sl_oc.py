...
data_root = '/workspace/data/fair_csar/VOC-SL/'
train_pipeline = [
...
data = dict(
    ...
    train=dict(
        type='SLDataset',
        ann_file='/media/syx/新加卷/MyResearch/VOC-SL/trainval/Annotations/',
        img_prefix='/media/syx/新加卷/MyResearch/VOC-SL/trainval/SLCMats/',
        pipeline=[
            dict(type='LoadSLCMatFromFile'),
            dict(
                type='MCAnalysis',
    ...
    val=dict(
        type='SLDataset',
        ann_file='/media/syx/新加卷/MyResearch/VOC-SL/test/Annotations/',
        img_prefix='/media/syx/新加卷/MyResearch/VOC-SL/test/SLCMats/',
        pipeline=[
            dict(type='LoadSLCMatFromFile'),
            dict(
                type='MCAnalysis',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=2000)))
work_dir = '/media/syx/新加卷/MyResearch/mmrotate/workdir/20250109/sl_pearson'
auto_resume = False
gpu_ids = range(0, 1)
