...
def eval_rbbox_map(det_results,
    ...
    for i in range(num_classes):
        ...
        # # # PR
        # str_recall = [str(recalls[x]) for x in range( len(recalls) )]
        # str_precision = [str(precisions[x]) for x in range( len(precisions) )]
        # line_recall = ' '.join(str_recall) + '\n'
        # line_precision = ' '.join(str_precision) + '\n'
        # save_recall = '/FAIR_CSAR/syx/work-dir/recall/' + str(i) + '.txt'
        # with open(save_recall, 'w') as f:
        #     f.write(line_recall)
        # save_precision = '/FAIR_CSAR/syx/work-dir/precision/' + str(i) + '.txt'
        # with open(save_precision, 'w') as f:
        #     f.write(line_precision)
